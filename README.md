...
This project is my solution in **Windows Legacy (Deprecated), C#** to the **Calculating Sums** practice found in section 04 practice 01 of the UiPath - RPA Developer Foundation course.
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S04P01-CalculatingSums-WindowsLegacy
```
